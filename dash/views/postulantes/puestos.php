                ...
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    <div class="ms-md-auto pe-md-3 d-flex align-items-center col-xl-3 col-lg-5 col-6">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="txtBuscar" name="txtBuscar" placeholder="Buscar puesto.">
                        </div>
                    </div>
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            <h6>Puestos de trabajo publicados</h6>
                        </div>
                                ...
                                <table id="myTable" class="table align-items-center mb-0">
                                    <thead>
                                        <tr class="sticky sticky-top bg-white" style="box-shadow: 0px 0px 20px -10px;">
                                            ...
                                            <th class="text-uppercase text-xxs font-weight-bolder opacity-7 ps-2">Empresa</th>
                                            <th class="text-uppercase text-xxs font-weight-bolder opacity-7 ps-2">Descripción</th>
                                            <th class="text-uppercase text-xxs font-weight-bolder opacity-7 ps-2">Fecha de creación</th>
