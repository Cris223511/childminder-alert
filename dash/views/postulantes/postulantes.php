...
<body class="g-sidenav-show bg-gray-100" id="contain-body" onload="cambiarTitulo('TopiTop | Postulantes')">
    ...
    <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 panel" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main" style="height: max-content !important">
            <ul class="navbar-nav">
                ...
                ?>
                    <li class="nav-item">
                        <a href="puestos.php" class="nav-link active">
                            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Puestos</li>
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Postulantes</li>
                    </ol>
                    <h6 class="font-weight-bolder text-white mb-0">Postulantes</h6>
                </nav>
                ...
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    <div class="ms-md-auto pe-md-3 d-flex align-items-center col-xl-3 col-lg-5 col-6">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="txtBuscar" name="txtBuscar" placeholder="Buscar postulante.">
                        </div>
                    </div>
                                ...
                                <table id="myTable" class="table align-items-center mb-0">
                                    <thead>
                                        <tr class="sticky sticky-top bg-white" style="box-shadow: 0px 0px 20px -10px;">
                                            ...
                                            <th class="text-uppercase text-xxs font-weight-bolder opacity-7 ps-2">Tipo Doc.</th>
                                            <th class="text-uppercase text-xxs font-weight-bolder opacity-7 ps-2">Número Doc.</th>
                                            <th class="text-uppercase text-xxs font-weight-bolder opacity-7 ps-2">Puntaje conocimientos</th>
                                            <th class="text-uppercase text-xxs font-weight-bolder opacity-7 ps-2">Puntaje examen psicologico</th>
                                            <th class="text-uppercase text-xxs font-weight-bolder opacity-7 ps-2">Puntaje entrevista oral</th>
                                            <th class="text-uppercase text-xxs font-weight-bolder opacity-7 ps-2">Puntaje total</th>
    ...
    <div class="fixed-plugin" id="ajustes">
        ...
        <a href="puestos.php" class="fixed-plugin-button text-dark position-fixed px-3 py-2" style="transform: translate(0, -70px)">
