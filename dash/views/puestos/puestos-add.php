...
<body class="g-sidenav-show bg-gray-100">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center mx-auto my-auto">
                        <h1 class="text-white mb-4" style="margin-top: -40px;">Crear puesto de trabajo</h1>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-2">
                                            <div class="form-group">
                                                <label for="titulo">Solicitudes disponibles:</label>
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="conocimientos" id="conocimientos" rows="5" maxlength="1000" placeholder="Ingrese los conocimientos requeridos en su puesto." required></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12 mb-2">
                                            <div class="form-group">
                                                <label for="titulo">Beneficios:</label>
                                                <textarea class="form-control" name="beneficios" id="beneficios" rows="5" maxlength="1000" placeholder="Ingrese los beneficios de su puesto." required></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12 mb-2">
                                            <div class="form-group">
                                                <label for="titulo">Requisitos:</label>
                                                <textarea class="form-control" name="requisitos" id="requisitos" rows="5" maxlength="1000" placeholder="Ingrese los requisitos de su puesto." required></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12 mb-2">
                                            <div class="form-group">
                                                <label for="titulo">Ofrecemos:</label>
                                                <textarea class="form-control" name="ofrendas" id="ofrendas" rows="5" maxlength="1000" placeholder="Ingrese qué ofrece en su puesto." required></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        window.onload = function() {
            cambiarTitulo('TopiTop | Crear Puestos')
        }
    </script>
