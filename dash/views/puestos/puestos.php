...
<body class="g-sidenav-show bg-gray-100" id="contain-body" onload="cambiarTitulo('TopiTop | Puestos')">
    ...
    <main class="main-content position-relative border-radius-lg ">
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder text-white mb-0">Puestos</h6>
                </nav>
                ...
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    <div class="ms-md-auto pe-md-3 d-flex align-items-center col-xl-3 col-lg-5 col-6">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="txtBuscar2" name="txtBuscar2" placeholder="Buscar puesto.">
                        </div>
                    </div>
        ...
        <div class="container-fluid py-2">
                        ...
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8 d-flex align-items-center">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">TUS PUESTOS DE TRABAJO</p>
                                </div>
            ...
            <div class="mt-4">
                ...
                <div class="row d-flex div-mostrado"></div>
    ...
    <div class="fixed-plugin" id="ajustes">
        ...
        ?>
            <a href="puestos-add.php" class="fixed-plugin-button text-dark position-fixed px-3 py-2 add" style="transform: translate(0, -70px)">
