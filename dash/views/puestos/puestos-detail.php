...
<body class="g-sidenav-show bg-gray-100">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center mx-auto my-auto">
                        <h1 class="text-white mb-4" style="margin-top: -40px;">Detalles del puesto de trabajo</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card-header px-4 py-sm-4 py-3">
                                ...
                                <p class="lead">Los siguientes datos son los detalles del puesto que seleccionaste, solo puedes visualizarlo.</p>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="titulo" id="titulo" maxlength="40" disabled>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="ubicacion" id="ubicacion" maxlength="50" disabled>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <div class="form-group">
                                                <label for="titulo">Horario:</label>
                                                <input type="text" class="form-control" name="horario" id="horario" maxlength="80" disabled>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <div class="form-group">
                                                <label for="titulo">Empresa:</label>
                                                <input type="text" class="form-control" name="empresa" id="empresa" maxlength="25" disabled>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6 mb-2">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="modalidad" id="modalidad" disabled>
                                                    <option value="">- Seleccione -</option>
                                        ...
                                        <div class="col-md-6 mb-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="area" id="area" maxlength="40" disabled>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="conocimientos" id="conocimientos" rows="7" maxlength="1000" disabled></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12 mb-2">
                                            <div class="form-group">
                                                <label for="titulo">Beneficios:</label>
                                                <textarea class="form-control" name="beneficios" id="beneficios" rows="7" maxlength="1000" disabled></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12 mb-2">
                                            <div class="form-group">
                                                <label for="titulo">Requisitos:</label>
                                                <textarea class="form-control" name="requisitos" id="requisitos" rows="7" maxlength="1000" disabled></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12 mb-2">
                                            <div class="form-group">
                                                <label for="titulo">Ofrecemos:</label>
                                                <textarea class="form-control" name="ofrendas" id="ofrendas" rows="7" maxlength="1000" disabled></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        window.onload = function() {
            cambiarTitulo('TopiTop | Detalles Puestos')
        }
    </script>
