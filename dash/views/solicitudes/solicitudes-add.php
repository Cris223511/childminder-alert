            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center mx-auto my-auto">
                        <h1 class="text-white mb-4" style="margin-top: -40px;">Generar solicitud</h1>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="motivo" id="motivo" rows="5" maxlength="300" placeholder="Ingrese el motivo de su solicitud." required></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
