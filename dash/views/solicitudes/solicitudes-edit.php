...
<body class="g-sidenav-show bg-gray-100">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center mx-auto my-auto">
                        <h1 class="text-white mb-4" style="margin-top: -40px;">Editar solicitud</h1>
                            ...
                            <form id="formulario" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-2">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="idtienda" id="idtienda" required>
                                        ...
                                        <div class="col-md-6 mb-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="puesto" id="puesto" maxlength="30" placeholder="Ingrese el nombre del puesto." required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <div class="form-group">
                                                <label for="titulo">Vacantes:</label>
                                                <input type="number" class="form-control" name="cant_vacantes" id="cant_vacantes" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="2" placeholder="Ingrese la cantidad de vacantes." required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <div class="form-group">
                                                <label for="titulo">Salario neto:</label>
                                                <input type="number" class="form-control" name="salario_neto" id="salario_neto" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="8" step="any" placeholder="Ingrese el salario neto (S/.)." required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <div class="form-group">
                                                <label for="titulo">Tiempo de contrato:</label>
                                                <input type="text" class="form-control" name="tiempo_contrato" id="tiempo_contrato" maxlength="20" placeholder="Ingrese el tiempo de contrato." required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <div class="form-group">
                                                <label for="ubicacion">Fecha de edición:</label>
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="motivo" id="motivo" rows="5" maxlength="300" placeholder="Ingrese el motivo de su solicitud."></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row p-4 pt-0">
                                    <div class="col-md-6 text-end ms-auto">
                                        <button type="submit" id="btnGuardar" class="btn bg-gradient-info mb-0">Enviar</button>
                                    </div>
                                </div>
                            </form>
                        </div>
    ...
    <script>
        window.onload = function() {
            cambiarTitulo('TopiTop | Editar Solicitud')
        }
    </script>
