...
<body class="g-sidenav-show bg-gray-100" id="contain-body" onload="cambiarTitulo('TopiTop | Solicitudes')">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Solicitudes</li>
                    </ol>
                    <h6 class="font-weight-bolder text-white mb-0">Solicitudes</h6>
                </nav>
                ...
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    <div class="ms-md-auto pe-md-3 d-flex align-items-center col-xl-3 col-lg-5 col-6">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="txtBuscar" name="txtBuscar" placeholder="Buscar solicitud.">
                        </div>
                    </div>
                                ...
                                <table id="myTable" class="table align-items-center mb-0">
                                    <thead>
                                        <tr class="sticky sticky-top bg-white" style="box-shadow: 0px 0px 20px -10px;">
                                            <th class="text-uppercase text-xxs font-weight-bolder opacity-7">Tienda</th>
                                            <th class="text-uppercase text-xxs font-weight-bolder opacity-7 ps-2">Jefe de tiendas</th>
                                            <th class="text-uppercase text-xxs font-weight-bolder opacity-7 ps-2">Puesto</th>
                                            <th class="text-uppercase text-xxs font-weight-bolder opacity-7 ps-2">Vacantes</th>
                                            <th class="text-uppercase text-xxs font-weight-bolder opacity-7 ps-2">Salario Neto</th>
                                            <th class="text-uppercase text-xxs font-weight-bolder opacity-7 ps-2">Tiempo Contrato</th>
    ...
    <div class="fixed-plugin" id="ajustes">
        ...
        <?php
        if ($_SESSION['rol'] == "admin" || $_SESSION['rol'] == "jefe_tienda") {
        ?>
            <a href="solicitudes-add.php" class="fixed-plugin-button text-dark position-fixed px-3 py-2 add" style="transform: translate(0, -70px)">
