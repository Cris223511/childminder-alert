...
<body class="g-sidenav-show bg-gray-100">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center mx-auto my-auto">
                        <h1 class="text-white mb-4" style="margin-top: -40px;">Editar dispositivo</h1>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="titulo" id="titulo" maxlength="30" placeholder="Ingrese el nombre del dispositivo." required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        window.onload = function() {
            cambiarTitulo('Childminder Alert | Editar Dispositivo')
        }
    </script>
