...
//     $.post('../../../../assets/main/config/ajax/postulantes.php?op=verificar', { "usuario": usuario, "clave": clave },
//         function (data) {
//             console.log(data);
...
//                 })
//                 setTimeout(function () {
//                     $(location).attr("href", "../../views/empleos.php");
//                 }, 2500);
//             } else {
...
//     $.ajax({
//         url: "../../../../assets/main/config/ajax/postulantes.php?op=registro",
//         type: "POST",
//         data: formData,
//         contentType: false,
//         processData: false,
